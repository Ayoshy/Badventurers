...
| Achievements | `Achievements.kt` | Badges, claim state, rewards, charter milestones, Reward Choice, and the Regional Liability Epic ticket reward exist. |
...
- Finish active uses for Armory/Forge, Infirmary, Tavern/Kitchen, and Accountant Office.
- Relic reward gates and post-Palier 3 reward layers.
