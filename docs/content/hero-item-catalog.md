...
| --- | --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- |
| brugg | `app/src/main/res-heroes/drawable-nodpi/hero_portrait_brugg.png` | Prototype rejected (BV-048) | Bruiser | Brugg | Common | 3 | Overconfident | RamshackleCharge | For95 Mag8 Lck36 Ego92 Hyg20 BF64 Ori38 Pap10 End88 Cha45 | P=For; S=End; T=Ego; Trait=Ego; Odd=BF; Extras=none | Portrait-shake prototype retained for runtime plumbing only; promotion ranks 0-4 planned; branching evolution TBD. |
| mira | `app/src/main/res-heroes/drawable-nodpi/hero_portrait_mira.png` | Prototype rejected (BV-048) | ApprenticeMage | Mira | Uncommon | 2 | ReadsManual | GlyphReader | For16 Mag90 Lck48 Ego54 Hyg72 BF38 Ori44 Pap76 End32 Cha52 | P=Mag; S=Pap; T=Lck; Trait=Pap; Odd=BF; Extras=none | Portrait-shake prototype retained for runtime plumbing only; promotion ranks 0-4 planned; branching evolution TBD. |
| nell | `app/src/main/res-heroes/drawable-nodpi/hero_portrait_nell.png` | Prototype rejected (BV-048) | Rogueish | Nell | Uncommon | 2 | SuspiciouslyLucky | LightFingers | For34 Mag28 Lck88 Ego58 Hyg46 BF74 Ori84 Pap26 End48 Cha62 | P=Lck; S=Ori; T=BF; Trait=Lck; Odd=Pap; Extras=none | Portrait-shake prototype retained for runtime plumbing only; promotion ranks 0-4 planned; branching evolution TBD. |
...
| sable | `app/src/main/res-heroes/drawable-nodpi/hero_portrait_ninja.png` | Candidate (BV-048 live test) | Ninja | Sable | Rare | 2 | SuspiciouslyLucky | NoTrace | For48 Mag48 Lck82 Ego74 Hyg64 BF78 Ori106 Pap32 End66 Cha58 | P=Ori; S=Lck; T=BF; Trait=Lck; Odd=Cha; Extras=+P at level multiples of 3 | Candidate Live-Lite animation pack exists for visual review only; promotion ranks 0-4 planned; branching evolution TBD. |
