...
object HeroProgression {
    ...
    private fun classGrowthProfile(heroClass: HeroClass): GrowthProfile = when (heroClass) {
        ...
        HeroClass.Bard -> GrowthProfile(StatType.Charisma, StatType.Magic, StatType.Luck)
        ...
        HeroClass.Quartermaster -> GrowthProfile(StatType.Orientation, StatType.Paperwork, StatType.Endurance)
